<script>
  ...
  import BarChart3Icon from "@lucide/svelte/icons/bar-chart-3"; import ZapIcon from "@lucide/svelte/icons/zap";
        ...
        <Sidebar.GroupContent>
          <Sidebar.Menu>
            {#each items as item (item.title)}
              <Sidebar.MenuItem>
                <Sidebar.MenuButton size="xl" class="flex justify-center">
                  {#snippet child({ props })}
